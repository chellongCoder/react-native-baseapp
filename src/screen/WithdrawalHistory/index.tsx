...
import withDrawalHistoryData from './data'
...
export default class WithDrawalHistory extends Component<IProps> {
            ...
            <View style={styles.aboveLeftRow}>
              <View style={styles.image}>
                <Image
                  ...
                  source={WITHDRAWALHISTORYICON}
                />
              </View>
              <View style={styles.contentView}>
                <Text style={styles.contentTxt}>Số tiền rút</Text>
              </View>
            </View>
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Header navigation={navigation} title="Lịch sử rút tiền" />
        <SectionListCustom
          section={withDrawalHistoryData}
